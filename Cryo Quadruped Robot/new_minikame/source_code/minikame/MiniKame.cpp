...
void MiniKame::jump() {
  float sentado[] = {
    90 - 25, 90 + 25, //front hips servos
    90 + 20, 90 - 20, //front leg servos
    90 - 65, 90 + 65, // back hip servos
...
void MiniKame::swim() {
  float sentado[] = {
    90 + 65, 90 - 65, //front hips servos
    90 - 65, 90 + 65, //front leg servos
    90 - 65, 90 + 65, // back hip servos
    90 + 65, 90 - 65  // back leg servos
  };
  moveServos(150, sentado);
  ...
  int T = 350;
  float period[] = {T, T, T, T, T, T, T, T};
  int amplitude[] = {20, 20, 20, 20, 20, 20, 20, 20};
  int offset[] = {
    90 + 65, 90 - 65, //front hips servos
    90 - 50, 90 + 50, //front leg servos
    90 - 65, 90 + 65, // back hip servos
    90 + 50, 90 - 50  // back leg servos
  };

  int phase[] = {10, 10, 10, 10, 10, 10, 10, 10};

  execute(3, period, amplitude, offset, phase);
}

void MiniKame::paddle() {
  float sentado[] = {
    90 + 65, 90 - 65, //front hips servos
    90 - 65, 90 + 65, //front leg servos
    90 - 55, 90 + 55, // back hip servos
    90 - 65, 90 + 65  // back leg servos
  };
  moveServos(150, sentado);
  delay(200);
  ...
  int T = 350;
  float period[] = {T, T, T, T, T, T, T, T};
  int amplitude[] = {0, 0, 0, 0, 20, 20, 20, 20};
  int offset[] = {
    90 + 65, 90 - 65, //front hips servos
    90 - 65, 90 + 65, //front leg servos
    90 - 65, 90 + 65, // back hip servos
    90 - 60, 90 + 60  // back leg servos
  };

  int phase[] = {0, 0, 0, 0, 10, 10, 10, 10};
